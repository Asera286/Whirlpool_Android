    ...
    public RoomModel doInBackground(Void... params) {
        try {
            ...
            if (responseCode == HttpsURLConnection.HTTP_OK) {
                ...
                String[] amenities = new String[amenitiesJson.length() - 1];
                ...
                if(rooms.length() > 0) {
                    ...
                    RoomModel model = new RoomModel(mBuildingName, mRoomName,
                            capacity, occupancyStatus, extension, roomType, amenities);
                    return model;
                }
            }
        }
